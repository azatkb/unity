...
public class LadybugBookPreviewBehavior : MonoBehaviour {
    ...
    void  Start(){
        ...
        ReadButton.onClick.AddListener(() =>{
            ...
            Book.GetComponent<LadybugBookReading>().StartReading();
        ...
        RecorButton.onClick.AddListener(() => {
            ...
            Assets.scripts.ColibriGame.Instance.StartRecording("LadybugBook"+ language);
